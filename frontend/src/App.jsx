  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/patient/complete-profile" element={<ProtectedRoute role="patient"><PatientCompleteProfile /></ProtectedRoute>} />
        ...
        <Route path="/doctor/complete-profile" element={<ProtectedRoute role="doctor"><DoctorCompleteProfile /></ProtectedRoute>} />
