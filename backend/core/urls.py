...
urlpatterns = [
    ...
    path('auth/google/doctor/', views.google_doctor_login_view, name='google_doctor_login'),
    path('patient/complete-profile/', views.complete_patient_profile_view, name='complete_patient_profile'),
    path('doctor/complete-profile/', views.complete_doctor_profile_view, name='complete_doctor_profile'),

    # Notifications
    path('notifications/', views.notifications_list_view, name='notifications_list'),
    path('notifications/mark-read/', views.mark_notification_read_view, name='mark_notification_read'),
